...
namespace PryServicios
{
    public partial class Login : Form
    {
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            ServiciosGeneral ObjServicioGeneral = new ServiciosGeneral();
            
            string v_usuario = "";
            int v_resultado1 = 0, v_resultado2 =0, v_Cpassword = 0, v_CUsuario = 0;

            v_Cpassword = txtPassword.TextLength;
            v_CUsuario = txtUsuario.TextLength;

            if (v_CUsuario == 0){
                MessageBox.Show("Debe completar el campo de Usuario", "Mensaje de Servifull", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (v_Cpassword == 0){
